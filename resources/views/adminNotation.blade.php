...
<body class="sidebar-mini sidebar-open" style="height: auto;">
    ...
    <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admin.blade')}}" class="nav-link active">
        ...
        <div class="content-wrapper" style="min-height: 1345.6px;">
            ...
            <section class="content-header" id="collectionCommentaire_">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Notes</h1>
    ...
    <table class="table">
        <thead>
            <tr>
                <th scope="col">Id</th>
                <th scope="col">qualitEns</th>
                <th scope="col">infrastructure</th>
                <th scope="col">recherche</th>
                <th scope="col">insertionPro</th>
        ...
        <tbody>
            @foreach ($notations as $notation)
                <tr>
                    ...
                    <td>{{ $comment -> qualitEns}}</td>
                    <td>{{ $comment -> infrastruture }}</td>
                    <td>{{ $comment -> recherche }}</td>
                    <td>{{ $comment -> insertionPro }}</td>
                    <td>
