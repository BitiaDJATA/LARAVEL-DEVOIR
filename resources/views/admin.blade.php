    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Djata bitia</a>
                    </div>
                </div>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="javascript:void(0);" class="nav-link active">
                                        ...
                                        <p>Ajouter Université</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('adminManage.blade')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>moderer commentaire</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('adminNotation.blade')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Liste des Notations</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper" style="min-height: 1345.6px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Forumulaire d'enregistrement</h3>
                                </div>
                                <form method="post" action="{{route('Universities.store')}}"  enctype="multipart/form-data">
                                @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="nomUniv">Non de l'université</label>
                                            <input type="text" class="form-control" name="nomUniv"
                                                placeholder="Non université">
                                        </div>
                                        ...
                                        <div class="form-group" height="300px">
                                            <label for="desscription">localisation</label>
            ...
            <section class="content-header">
                ...
                <section class="content" id="collectionUniversite_">
                <h2>Liste des Universités</h2>
    <table class="table">
        <thead>
            <tr>
                <th scope="col">Id</th>
                <th scope="col">NomUniv</th>
        ...
        <tbody>
            @foreach ($universities as $university)
                <tr>
                    ...
                    <td>{{ $university -> localisation }}</td>
                    <td>{{ $university -> description}}</td>
                    <td> <img src="{{ asset('storage/' . $university->image) }}" width="100px"  alt="New Lecturer Meeting"></td>
                    <td>
